...
namespace WebApp
{
    public class MeterSimulator
    {
        ...
        public double SimulatedConsumption(DateTime dt, double consumptionFactor, bool withoutNoise)
        {
            ...
            var noise = withoutNoise ? 1 : GaussianRandom(random, 1.0, 0.2);

            return noise * consumptionFactor / SecondsPerYear * seasonFactor * timeOfDayFactor * 60 * 60;
        }
